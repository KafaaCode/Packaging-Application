...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({required this.count, required this.min});
  ...
  @override
  String toString() {
    return 'CounterState(count: $count, min: $min)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, count, min);
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      {required final int count, required final int min}) = _$CounterStateImpl;

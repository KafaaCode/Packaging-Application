                ...
                ListTile(
                  ...
                  trailing: SizedBox(
                    ...
                    child: BlocBuilder<LanguageCubit, LanguageState>(
                      builder: (context, state) {
                        List<SupportedLanguage> langs = LanguageCubit.supportedLanguages;
                        return DropdownCustom<SupportedLanguage>(
                          items: langs,
                          onChanged: (v) {
                            if (v != null) {
                              context.read<LanguageCubit>().changeLanguageTo(v.langCode);
                            }
                          },
                          ...
                          defaultValue: langs.firstWhere(
                                (element) => element.langCode == state.locale.languageCode,
                          ),

    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: isLoading
          ...
          child: ListView(
            children: [
              _infoTile('رقم الطلب:', orderData!['serial_number'].toString()),
              _infoTile('الحالة:', orderData!['status'].toString()),
              _infoTile('الوقت المتوقع للتوصيل:', orderData!['delivery_time'].toString()),
              _infoTile('الرسالة:', orderData!['reply_message'].toString()),
              _infoTile('السعر الإجمالي:', '${orderData!['total_price']} \$'),
              _infoTile('تاريخ الإنشاء:', orderData!['created_at'].toString()),
              _infoTile('اسم المستخدم:', orderData!['user_name'].toString()),
              _infoTile('البريد الإلكتروني:', orderData!['user_email'].toString()),
              _infoTile('رقم الهاتف:', orderData!['user']?['phone'] ?? 'غير متوفر'),
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'Partial Delivery', child: Text('توصيل جزئي')),

...
class _UsersPageState extends State<UsersPage> {
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              userInfoRow(Icons.calendar_today, 'تاريخ الإنشاء', user.createdAt.split('T')[0]),
            ],
          ),
          actions: [
            Center(
  ...
  Widget userInfoRow(IconData icon, String label, String value, {Color? iconColor}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
                ...
                children: [
                  const Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.supervised_user_circle, size: 40, color: Color(0xFF70b9be)),
                    ],
                  ),
